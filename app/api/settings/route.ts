...
const defaults = { id: 1, enabled: false, theme: "", audience: "", tone: "親しみやすく、誠実", rules: "", postsPerWeek: 3, postingTime: "08:00", imageMode: "auto", reviewMode: false, nextRunAt: null };
...
export async function POST(request: Request) {
  try {
    ...
    const postsPerWeek = Math.min(14, Math.max(1, Number(body.postsPerWeek) || 3));
